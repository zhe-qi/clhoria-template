 ...
 * 创建字典Schema
 */
export const insertDictionariesSchema = createInsertSchema(sysDictionaries, {
 ...
 * 更新字典Schema
 */
export const patchDictionariesSchema = insertDictionariesSchema.partial();

/**
 * 响应字典Schema（用于API响应）
 */
export const responseDictionariesSchema = selectDictionariesSchema;
