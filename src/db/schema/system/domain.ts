...
export const selectSystemDomainSchema = createSelectSchema(systemDomain, {
  id: schema => schema.meta({ description: "域ID" }),
  code: schema => schema.meta({ description: "域代码" }),
  name: schema => schema.meta({ description: "域名称" }),
  description: schema => schema.meta({ description: "域描述" }),
