...
import { sysMenus } from "./sys-menus.index";
...
function createSysMenusApp() {
  return createApp()
    .use("/sys-menus/*", jwt({ secret: env.ADMIN_JWT_SECRET }))
    .use("/sys-menus/*", casbin())
    .use("/sys-menus/*", operationLog({ moduleName: "后台管理", description: "后台管理操作" }))
    .route("/", sysMenus);
}
...
describe("sysMenus routes with real authentication", () => {
  ...
  beforeAll(async () => {
    await collectAndSyncEndpointPermissions([
      { name: "sys-menus", app: sysMenus, prefix: "" },
    ]);
  ...
  it("access without token should return 401", async () => {
    const response = await sysMenusClient["sys-menus"].$get({
      query: {
        page: "1",
        limit: "10",
      },
  ...
  it("admin should be able to create menu", async () => {
    ...
    const response = await sysMenusClient["sys-menus"].$post(
      {
        json: testMenu,
      },
      {
  ...
  it("admin should be able to get menu tree", async () => {
    ...
    const response = await sysMenusClient["sys-menus"].tree.$get(
      {
        query: {},
      },
      {
  ...
  it("admin should be able to get constant routes", async () => {
    ...
    const response = await sysMenusClient["sys-menus"].constant.$get(
      {},
      {
        headers: {
          Authorization: `Bearer ${adminToken}`,
  ...
  it("admin should be able to get user routes", async () => {
    ...
    const response = await sysMenusClient["sys-menus"]["user-routes"].$get(
      {},
      {
        headers: {
          Authorization: `Bearer ${adminToken}`,
  ...
  it("admin should be able to get single menu", async () => {
    ...
    const response = await sysMenusClient["sys-menus"][":id"].$get(
      {
        param: {
          id: createdMenuId,
        },
  ...
  it("admin should be able to update menu", async () => {
    ...
    const response = await sysMenusClient["sys-menus"][":id"].$patch(
      {
        param: {
          id: createdMenuId,
        },
  ...
  it("admin should be able to delete menu", async () => {
    ...
    const response = await sysMenusClient["sys-menus"][":id"].$delete(
      {
        param: {
          id: createdMenuId,
        },
