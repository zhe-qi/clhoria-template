...
import { sysEndpoints } from "./sys-endpoints.index";
...
function createSysEndpointsApp() {
  return createApp()
    .use("/sys-endpoints/*", jwt({ secret: env.ADMIN_JWT_SECRET }))
    .use("/sys-endpoints/*", casbin())
    .use("/sys-endpoints/*", operationLog({ moduleName: "API端点管理", description: "API端点管理操作" }))
    .route("/", sysEndpoints);
}
...
describe("sysEndpoints routes with real authentication", () => {
  ...
  beforeAll(async () => {
    await collectAndSyncEndpointPermissions([
      { name: "sys-endpoints", app: sysEndpoints, prefix: "" },
    ]);
  ...
  it("access without token should return 401", async () => {
    const response = await sysEndpointsClient["sys-endpoints"].$get({
      query: {
        page: "1",
        limit: "10",
      },
  ...
  it("admin should be able to create endpoint", async () => {
    ...
    const response = await sysEndpointsClient["sys-endpoints"].$post(
      {
        json: testEndpoint,
      },
      {
  ...
  it("admin should be able to get endpoints tree", async () => {
    ...
    const response = await sysEndpointsClient["sys-endpoints"].tree.$get(
      {},
      {
        headers: {
          Authorization: `Bearer ${adminToken}`,
  ...
  it("admin should be able to get auth endpoints by role", async () => {
    ...
    const response = await sysEndpointsClient["sys-endpoints"].auth[":roleCode"].$get(
      {
        param: {
          roleCode: "admin",
        },
  ...
  it("admin should be able to get single endpoint", async () => {
    ...
    const response = await sysEndpointsClient["sys-endpoints"][":id"].$get(
      {
        param: {
  ...
  it("admin should be able to update endpoint", async () => {
    ...
    const response = await sysEndpointsClient["sys-endpoints"][":id"].$patch(
      {
        param: {
          id: createdEndpointId,
        },
  ...
  it("admin should be able to delete endpoint", async () => {
    ...
    const response = await sysEndpointsClient["sys-endpoints"][":id"].$delete(
      {
        param: {
          id: createdEndpointId,
        },
