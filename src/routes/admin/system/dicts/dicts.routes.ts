...
import { systemDictCreateSchema, systemDictIdParams, systemDictListResponse, systemDictPatchSchema, systemDictQuerySchema, systemDictResponseSchema } from "./dicts.schema";
