...
import { sysRoles } from "./sys-roles.index";
...
function createSysRolesApp() {
  return createApp()
    .use("/sys-roles/*", jwt({ secret: env.ADMIN_JWT_SECRET }))
    .use("/sys-roles/*", casbin())
    .use("/sys-roles/*", operationLog({ moduleName: "后台管理", description: "后台管理操作" }))
    .route("/", sysRoles);
}
...
describe("sysRoles routes with real authentication", () => {
  ...
  beforeAll(async () => {
    await collectAndSyncEndpointPermissions([
      { name: "sys-roles", app: sysRoles, prefix: "" },
    ]);
  ...
  it("access without token should return 401", async () => {
    const response = await sysRolesClient["sys-roles"].$get({
      query: {
        page: "1",
        limit: "10",
      },
  ...
  it("admin should be able to create role", async () => {
    ...
    const response = await sysRolesClient["sys-roles"].$post(
      {
        json: testRole,
      },
      {
  ...
  it("admin should be able to get single role", async () => {
    ...
    const response = await sysRolesClient["sys-roles"][":id"].$get(
      {
        param: {
          id: createdRoleId,
        },
  ...
  it("admin should be able to update role", async () => {
    ...
    const response = await sysRolesClient["sys-roles"][":id"].$patch(
      {
        param: {
          id: createdRoleId,
        },
  ...
  it("admin should be able to assign permissions", async () => {
    ...
    const response = await sysRolesClient["sys-roles"][":id"].permissions.$post(
      {
        param: {
          id: createdRoleId,
        },
  ...
  it("admin should be able to assign menus", async () => {
    ...
    const response = await sysRolesClient["sys-roles"][":id"].menus.$post(
      {
        param: {
          id: createdRoleId,
        },
  ...
  it("admin should be able to assign users", async () => {
    ...
    const response = await sysRolesClient["sys-roles"][":id"].users.$post(
      {
        param: {
          id: createdRoleId,
        },
  ...
  it("admin should be able to delete role", async () => {
    ...
    const response = await sysRolesClient["sys-roles"][":id"].$delete(
      {
        param: {
          id: createdRoleId,
        },
