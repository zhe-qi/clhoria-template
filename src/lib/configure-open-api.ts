...
const APP_CONFIG: AppConfig[] = [
  {
    name: "admin",
    title: "管理端API文档",
    token: "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1aWQiOiIwMTk4MTIyMS0zNjJhLTc1ZjktYWYxOC0wODhhZjNjZDY3ZGEiLCJ1c2VybmFtZSI6InNveWJlYW4iLCJkb21haW4iOiJidWlsdC1pbiIsImlhdCI6MTc1MzAwNzg2MiwiZXhwIjoxNzUzNjEyNjYyLCJqdGkiOiI3NTAwMmMzNC01YzdmLTQ3ZTAtYWJkMC01ZTAyNGE1YWMyMmIiLCJ0eXBlIjoiYWNjZXNzIn0.Cmn3aoHBoaMjYdWgBvCnDYc_FGZx-v3sMtaE763GKSo",
  },
  {
    name: "client",
    title: "客户端API文档",
