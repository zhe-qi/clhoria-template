...
const APP_CONFIG: AppConfig[] = [
  {
    name: "admin",
    title: "管理端API文档",
    token: "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.._Qet7NLBePddJjt3IqqailjdzX7KOHAC2FnxuZ75_20",
  },
  {
    name: "client",
    title: "客户端API文档",
