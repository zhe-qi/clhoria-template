...
const APP_CONFIG: AppConfig[] = [
  {
    name: "admin",
    title: "管理端API文档",
    token: "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1aWQiOiIwMTk4MmIzZC0yZTBlLTc1ZDAtOWQwNC1kMjc1NWI0ZWM5ZWIiLCJ1c2VybmFtZSI6InN1cGVyIiwiZG9tYWluIjoiYnVpbHQtaW4iLCJpYXQiOjE3NTMwOTM2OTEsImV4cCI6MTc1MzY5ODQ5MSwianRpIjoiMGJjZDNmMTQtOGQ3Ny00YjY0LWI0MGYtMTRlZDhmNGYyZWJkIiwidHlwZSI6ImFjY2VzcyJ9.eP3-4hVOrtfMXikantK87qgPPLkW5l8vjsbCdheUrlE",
  },
  {
    name: "client",
    title: "客户端API文档",
